...
public class InnReservations {
  public static String jdbcURL = System.getenv("LAB7_JDBC_URL");
  public static String dbUsername = System.getenv("LAB7_JDBC_USER");
  public static String dbPassword = System.getenv("LAB7_JDBC_PW");
  ...
  private static String request(int input) throws SQLException {
    try {
      String result = "";
      switch (input) {
        case 0:
